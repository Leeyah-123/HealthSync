...
const Main = () => {
  return (
    <div className='flex flex-col-reverse mx-0 my-auto md:flex-row lg:flex-row justify-between items-center relative'>
        ...
        <div className='absolute w-[50%] h-[50%] md:w-[60%] md:h-[60%] lg:w-[47%] lg:h-[47%] bg-[#CDFB47] rounded-b-full -top-[20%] -left-[34%] md:-top-[34%] md:-left-[24%] lg:-top-10 lg:-left-[24%]'></div>

        <div className='hidden lg:flex absolute lg:w-[50%] lg:h-[55%] bg-[#CDFB47] rounded-t-full -bottom-4 -right-[24%]'></div>
