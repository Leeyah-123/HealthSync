    ...
    <section ref={productRef}>
      ...
      <div className="my-10 md:my-20 grid gap-10 text-center md:grid-cols-3 md:gap-8 md:text-left">
        {products.map((product) => (
          <div
            key={product.id}
            className="product opacity-0 relative bottom-[40px] bg-lightGray rounded-3xl"
          >
            <p className="bg-lemon w-fit h-fit m-5 rounded-full py-3 ml-2 px-4 text-2xl font-bold">
              0{product.id}
            </p>
            ...
            <article className=" py-10 bg-btblack text-bgray rounded-b-2xl font-bold flex justify-around md:py-5 mt-5">
              ...
              <p className="bg-lemon rounded-full h-fit p-3 mt-1.5 text-btblack">
                <FaArrowRight />
              </p>
            </article>
          </div>
