...
const Product = () => {
  return (
    <section>
      ...
      <div className="my-10 md:my-20 grid gap-10 text-center md:grid-cols-3 md:gap-3 md:text-left">
        {products.map((product) => (
          <div key={product.id} className="bg-lightGray rounded-3xl">
            ...
            <p className="text-lg px-2  sm:px-20 md:px-2">{product.text}</p>
